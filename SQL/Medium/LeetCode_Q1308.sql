...
INSERT INTO Scores_1308 (player_name, gender, day, score_points) VALUES
('Aron', 'F', '2020-01-01', 17),
('Alice', 'F', '2020-01-07', 23),
('Bajrang', 'M', '2020-01-07', 7),
('Khali', 'M', '2019-12-25', 11),
...
SELECT gender , day,
SUM(score_points) OVER(PARTITION BY gender ORDER BY day) as score_points
FROM Scores_1308;
